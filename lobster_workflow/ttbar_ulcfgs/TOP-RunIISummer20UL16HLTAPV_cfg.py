...
# with command line options: --era Run2_2016 --inputCommands keep *,drop *_*_BMTF_*,drop *PixelFEDChannel*_*_*_* --customise Configuration/DataProcessing/Utils.addMonitoring --outputCommand keep *_mix_*_*,keep *_genPUProtons_*_* --step HLT:25ns15e33_v4 --geometry DB:Extended --conditions 80X_mcRun2_asymptotic_2016_TrancheIV_v6 --customise_commands process.source.bypassVersionCheck = cms.untracked.bool(True) --datatier GEN-SIM-RAW --eventcontent RAWSIM --python_filename TOP-RunIISummer20UL16HLTAPV_cfg.py --fileout file:HLT-00000.root --filein file:DIGI-00000.root --no_exec --mc
