...
# with command line options: --era Run2_2016 --customise Configuration/DataProcessing/Utils.addMonitoring --step RAW2DIGI,L1Reco,RECO,RECOSIM --geometry DB:Extended --conditions 106X_mcRun2_asymptotic_v13 --datatier AODSIM --eventcontent AODSIM --python_filename TOP-RunIISummer20UL16RECO_cfg.py --fileout file:RECO-00000.root --filein file:HLT-00000.root --runUnscheduled --no_exec --mc
