...
# with command line options: Configuration/GenProduction/python/pythia-fragment-mtt0to700.py --era Run2_2018 --customise Configuration/DataProcessing/Utils.addMonitoring --beamspot Realistic25ns13TeVEarly2018Collision --step LHE,GEN --geometry DB:Extended --conditions 106X_upgrade2018_realistic_v4 --customise_commands process.source.numberEventsInLuminosityBlock=cms.untracked.uint32(280) --datatier GEN,LHE --eventcontent RAWSIM,LHE --python_filename TOP-RunIISummer20UL18wmLHEGEN-mtt0to700_cfg.py --fileout file:GEN-00000.root --number 10 --no_exec --mc
