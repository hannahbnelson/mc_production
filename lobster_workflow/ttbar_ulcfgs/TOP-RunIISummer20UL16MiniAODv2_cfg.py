...
# with command line options: --era Run2_2016,bParking --customise Configuration/DataProcessing/Utils.addMonitoring --procModifiers run2_miniAOD_UL --step PAT --geometry DB:Extended --conditions 106X_mcRun2_asymptotic_v17 --datatier MINIAODSIM --eventcontent MINIAODSIM --python_filename TOP-RunIISummer20UL16MiniAODv2_cfg.py --fileout file:MAOD-00000.root --filein file:RECO-00000.root --runUnscheduled --no_exec --mc
...
process = cms.Process('PAT',Run2_2016,bParking,run2_miniAOD_UL)
