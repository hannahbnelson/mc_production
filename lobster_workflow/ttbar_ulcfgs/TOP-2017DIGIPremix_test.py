...
# with command line options: --era Run2_2017 --customise Configuration/DataProcessing/Utils.addMonitoring --procModifiers premix_stage2 --datamix PreMix --step DIGI,DATAMIX,L1,DIGI2RAW --geometry DB:Extended --conditions 106X_mc2017_realistic_v6 --datatier GEN-SIM-DIGI --eventcontent PREMIXRAW --python_filename TOP-RunIISummer20UL17DIGIPremix_cfg.py --fileout file:DIGI-00000.root --filein file:SIM-00000.root --pileup_input dbs:/Neutrino_E-10_gun/RunIISummer20ULPrePremix-UL17_106X_mc2017_realistic_v6-v3/PREMIX --runUnscheduled --no_exec --mc
...
process.source = cms.Source("PoolSource",
    ...
    fileNames = cms.untracked.vstring('file:SIM-00000.root'),
...
process.PREMIXRAWoutput = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('file:DIGI-00000.root'),
...
process.mixData.input.fileNames = cms.untracked.vstring(['root://cmsxcache.crc.nd.edu//store/mc/RunIISummer20ULPrePremix/Neutrino_E-10_gun/PREMIX/UL17_106X_mc2017_realistic_v6-v3/00000/00A9E107-166F-1243-8FF4-CB7B8466EC4D.root'])
