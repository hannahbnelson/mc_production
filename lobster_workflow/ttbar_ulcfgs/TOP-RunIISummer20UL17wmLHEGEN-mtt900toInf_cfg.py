...
# with command line options: Configuration/GenProduction/python/pythia-fragment-mtt900toInf.py --era Run2_2017 --customise Configuration/DataProcessing/Utils.addMonitoring --beamspot Realistic25ns13TeVEarly2017Collision --step LHE,GEN --geometry DB:Extended --conditions 106X_mc2017_realistic_v6 --customise_commands process.source.numberEventsInLuminosityBlock=cms.untracked.uint32(1369) --datatier GEN,LHE --eventcontent RAWSIM,LHE --python_filename TOP-RunIISummer20UL17wmLHEGEN-mtt900toInf_cfg.py --fileout file:GEN-00000.root --number 1369 --number_out 100 --no_exec --mc
