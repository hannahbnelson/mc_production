...
master_label = 'postSIM_EFT_{tstamp}'.format(tstamp=timestamp_tag)
...
SIM_dirs_all = {
    ...
    #             os.path.join(input_dir_path, "hnelson2/mc/ttbarEFT_Run2/UL16APV/SIM/v1/SIM_TTto2L2Nu_1Jets_smeft_MTT_0to700/"),
    #         ],
    # },
    # "UL16": {
    #   "TTto2L2Nu_1Jets_smeft_MTT_0to700":     os.path.join(input_dir_path, "hnelson2/mc/ttbarEFT_Run2/UL16/SIM/v1/SIM_TTto2L2Nu_1Jets_smeft_MTT_0to700/"),
    #   "TTto2L2Nu_1Jets_smeft_MTT_700to900":   os.path.join(input_dir_path, "hnelson2/mc/ttbarEFT_Run2/UL16/SIM/v2/SIM_TTto2L2Nu_1Jets_smeft_MTT_700to900/"),
    #   "TTto2L2Nu_1Jets_smeft_MTT_900toInf":   os.path.join(input_dir_path, "hnelson2/mc/ttbarEFT_Run2/UL16/SIM/v2/SIM_TTto2L2Nu_1Jets_smeft_MTT_900toInf/"),
    # },
    ...
    # },
    "UL18": {
      # "TTto2L2Nu_1Jets_smeft_MTT_0to700":     os.path.join(input_dir_path, "hnelson2/mc/ttbarEFT_Run2/UL18/SIM/v1/SIM_TTto2L2Nu_1Jets_smeft_MTT_0to700/"),
      # "TTto2L2Nu_1Jets_smeft_MTT_700to900":   os.path.join(input_dir_path, "hnelson2/mc/ttbarEFT_Run2/UL18/SIM/v1/SIM_TTto2L2Nu_1Jets_smeft_MTT_700to900/"),
      "TTto2L2Nu_1Jets_smeft_MTT_900toInf":   os.path.join(input_dir_path, "hnelson2/mc/ttbarEFT_Run2/UL18/SIM/v1/SIM_TTto2L2Nu_1Jets_smeft_MTT_900toInf/"),
    },
    # "UL17_test": {
...
sim_dirs = SIM_dirs_all[UL_YEAR]
for name, sim_path in sim_dirs.items():
    print(f"SIM input dir: {sim_path}")
    ...
    wfs.extend([digi, hlt, reco, maod, naod])
