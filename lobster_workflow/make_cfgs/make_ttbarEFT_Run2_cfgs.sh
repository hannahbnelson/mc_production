...
(
	...
	cmsDriver.py  --era Run2_2016_HIPM,run2_nanoAOD_106Xv2 --customise Configuration/DataProcessing/Utils.addMonitoring --step NANO --conditions 106X_mcRun2_asymptotic_preVFP_v11 --datatier NANOAODSIM --eventcontent NANOEDMAODSIM --python_filename TOP-RunIISummer20UL16NanoAODAPVv9_cfg.py --fileout file:$FNANO --filein file:$FMINI --no_exec --mc
	cmsDriver.py  --era Run2_2016,run2_nanoAOD_106Xv2 --customise Configuration/DataProcessing/Utils.addMonitoring --step NANO --conditions 106X_mcRun2_asymptotic_v17 --datatier NANOAODSIM --eventcontent NANOEDMAODSIM --python_filename TOP-RunIISummer20UL16NanoAODv9_cfg.py --fileout file:$FNANO --filein file:$FMINI --no_exec --mc
	cmsDriver.py  --era Run2_2017,run2_nanoAOD_106Xv2 --customise Configuration/DataProcessing/Utils.addMonitoring --step NANO --conditions 106X_mc2017_realistic_v9 --datatier NANOAODSIM --eventcontent NANOEDMAODSIM --python_filename TOP-RunIISummer20UL17NanoAODv9_cfg.py --fileout file:$FNANO --filein file:$FMINI --no_exec --mc
	cmsDriver.py  --era Run2_2018,run2_nanoAOD_106Xv2 --customise Configuration/DataProcessing/Utils.addMonitoring --step NANO --conditions 106X_upgrade2018_realistic_v16_L1v1 --datatier NANOAODSIM --eventcontent NANOEDMAODSIM --python_filename TOP-RunIISummer20UL18NanoAODv9_cfg.py --fileout file:$FNANO --filein file:$FMINI  --no_exec --mc
)