...
process.source = cms.Source("EmptySource",
    numberEventsInLuminosityBlock = cms.untracked.uint32(1369)
)
...
process.SiStripSimBlock = cms.PSet(
    ...
    fracOfEventsToSimAPV = cms.double(1.0),
    includeAPVSimulation = cms.bool(True),
...
process.GlobalTag = cms.ESSource("PoolDBESSource",
    ...
    globaltag = cms.string('106X_mcRun2_asymptotic_preVFP_v8'),
...
process.schedule = cms.Schedule(*[ process.lhe_step, process.generation_step, process.genfiltersummary_step, process.endjob_step, process.RAWSIMoutput_step, process.LHEoutput_step ], tasks=[process.patAlgosToolsTask])
